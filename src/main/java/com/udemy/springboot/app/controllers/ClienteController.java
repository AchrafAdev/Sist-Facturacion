...
public class ClienteController {
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
			Authentication authenticacion, HttpServletRequest request) {
		...
		if(securityContext.isUserInRole("ADMIN")) {
			...
			logger.info("Usando SecurityContextHolderAware: Hola. ".concat(auth.getName()).concat(" NO tienes acceso!"));
		}
	...
	public String crear(Map<String, Object> model) {
		...
		model.put("valor", "Guardar Cliente");
		return "form";
	}
	...
	public String editar(@PathVariable(value = "id") Long id, Map<String, Object> model, RedirectAttributes flash) {
		...
		model.put("valor", "Editar Cliente");
		return "form";
	}
